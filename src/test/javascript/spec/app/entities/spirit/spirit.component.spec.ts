...
import { SpiritComponent } from 'app/entities/spirit/spirit.component';
import { SpiritService } from 'app/entities/spirit/spirit.service';
import { Spirit } from 'app/shared/model/spirit.model';

describe('Component Tests', () => {
    describe('Spirit Management Component', () => {
        let comp: SpiritComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SpiritComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.spirits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
