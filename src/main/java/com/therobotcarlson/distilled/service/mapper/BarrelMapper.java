 ...
 */
@Mapper(componentModel = "spring", uses = {WarehouseMapper.class, MashbillMapper.class, CustomerMapper.class, BatchMapper.class})
public interface BarrelMapper extends EntityMapper<BarrelDTO, Barrel> {
    ...
    @Mapping(source = "batch.orderCode", target = "batchOrderCode")
