 ...
 */
@Entity
@Table(name = "master_summary")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
@Document(indexName = "mastersummary")
public class MasterSummary implements Serializable {
    ...
    public MasterSummary proofGallons(Integer proofGallons) {
    ...
    public MasterSummary actualBarrelCount(Integer actualBarrelCount) {
    ...
    public boolean equals(Object o) {
        ...
        MasterSummary masterSummary = (MasterSummary) o;
        if (masterSummary.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), masterSummary.getId());
    }
